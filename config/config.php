...
if ($isApiRequest) {
    // API: suppress display, log errors
    error_reporting(E_ALL);
    ini_set('display_errors', 0);
    ini_set('log_errors', 1);
} elseif (APP_ENV === 'development' && APP_DEBUG) {
    // Development web pages: show errors
    error_reporting(E_ALL);
    ini_set('display_errors', 1);
} else {
    // Production: suppress notices/deprecated
...
// If session is already started (e.g., by API files), skip this
